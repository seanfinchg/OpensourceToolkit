...
export const tools: ITool[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Waist-to-Hip & Waist-to-Height Ratios",
      "Weight Goals & Timeline",
    ...
    href: "/bmi-calculator",
    seo: {
      title: "BMI Calculator - Body Mass Index, BMR, TDEE & Health Metrics",
      description:
        "Comprehensive BMI calculator with body composition analysis, BMR, TDEE, ideal weight calculations, and personalized weight goals. Features imperial/metric units, health recommendations, and progress tracking.",
      keywords:
        "bmi calculator, body mass index, bmr calculator, tdee calculator, body fat calculator, ideal weight calculator, weight loss calculator, metabolism calculator, health calculator, fitness calculator, calorie calculator, body composition, weight goals, health metrics",
    },
  },
  {
    id: "evm-vanity",
